...
public class Game
{
    ...
    /**
     * The game is over if there is only one pawn left or if a pawn possesses 5 gold or more.
     * 
     ...
     * 
     * @param d
     *            The direction in which the pawn must move.
     * @return A message regarding what happened.
     * @throws OutOfBoardException
     *             If the move is invalid regarding the board.
     */
    public String moveNextPawn(final Direction d) throws OutOfBoardException {
