...
abstract class AbstractGridShape extends JComponent
{
    ...
    public int                   x = 0;
    public int                   y = 0;
    private final ExampleDisplay dis;
    ...
    public void paint(Graphics g) {
        this.drawShape(g, dis.cellSize / 2 + x * dis.cellSize, dis.cellSize / 2 + y * dis.cellSize, dis.cellSize, dis.cellSize);
    }
...
public class ExampleDisplay extends JFrame implements KeyListener
{
    ...
    /*
     * gameMap contains the plan of the sweets to collect initialized to null by
     * default
     */
